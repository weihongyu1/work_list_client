<template>
  ...
  <div style="width: 50%;border-right: 1px solid #f4f4f5;float: left;">
    ...
    <div style="margin-top: 20px">
      <input v-model="task.task" class="input-task" type="text" placeholder="+ 添加工作任务"/>
      <el-date-picker
          v-model="task.date"
          type="datetime"
      ...
      <!--      分类-->
      <span class="el-dropdown-link" style="color: #ff6681;cursor: pointer;margin-left: 5px">工作任务</span>
