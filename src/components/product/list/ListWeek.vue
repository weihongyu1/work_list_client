<template>
  ...
  <div style="width: 50%;border-right: 1px solid #f4f4f5;float: left;">
    ...
    <span class="el-dropdown-link" style="color: #ff6681;cursor: pointer">
      分类
      <img src="../../../static/img/icon/down.png" style="height: 10px" alt="未加载">
    ...
    <div>
      <ul>
        <li v-for="(item,index) in tasks" class="task" @click="listDetails(item)">
          ...
          <img src="../../../static/img/icon/delete.png" class="delete-task" style="height: 15px;margin-left: 30px;" @click="deleteTask(item)" alt="未加载">
        </li>
      </ul>
    </div>
  </div>
